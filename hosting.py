...
# ==================== RAILWAY CONFIGURATION ====================
# Railway Variables se Token aur IDs uthayega, agar nahi mile toh default use karega (Local ke liye)
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8551428121:AAF47JeY-D7AK2rAhC908jGjesBTEpasl14")
...
CHANNEL_USERNAME = os.environ.get("CHANNEL_USERNAME", "rajexpilot")  # <-- SAME (Aapka Channel)
...
def main_menu_keyboard(user_id):
    ...
    markup.add(
        types.InlineKeyboardButton("📢 Official Channel", url=f"https://t.me/{CHANNEL_USERNAME}"),
...
def callback_handler(call):
    ...
    if call.data == "main_menu":
        ...
        markup.add(types.InlineKeyboardButton("💬 Send TrxID to Admin", url=f"https://t.me/{ADMIN_USERNAME}"))
